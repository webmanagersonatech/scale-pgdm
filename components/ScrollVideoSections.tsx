...
const sections = [
  {
    ...
    points: [
      ...
      "Over 100+ clients annually",
      "1 in 10 live projects with international firms",
    ],
  ...
  },
  {
    id: 2,
    tag: "STUDENTS FUND",
    title: "Invest From  Student Fund",
    points: [
  ...
  },
  {
    id: 3,
    tag: "OFF-CAMPUS",
    title: "Explore India’s Premier Campus",
    points: [
...
export default function ScrollVideoSections() {
  ...
  return (
    <div
      className="bg-gradient-to-t from-[#c7a289] via-[#f5f0eb] to-white
 opacity-90 py-10"
    >
