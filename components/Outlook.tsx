...
export default function OutlookPage() {
  const features = [
    {
      ...
      description:
        "From Day 1, students master the tools that power modern business—analytics, AI, automation, digital strategy, and cloud ecosystems.",
      icon: faTrophy,
    ...
    },
    {
      ...
      description:
        "The Sona Valliappa Group’s impact in technology, manufacturing, education, and innovation forms a solid foundation for SSBM's cutting-edge business education model.",
      icon: faChartBar,
    ...
    },
    {
      ...
      description:
        "With global partnerships and internationally benchmarked curriculum, SSBM's prepares students to pursue leadership roles worldwide.",
      icon: faGlobe,
    ...
    },
    {
      ...
      description:
        "The fully residential program nurtures a thriving environment of collaboration, creativity, and high-energy learning.",
      icon: faLightbulb,
  ...
  const pgdmPrograms = [
    ...
    },
    {
      ...
      icon: faUserGraduate,
      description: "Enhance communication, soft skills, and career readiness.",
    },
  ];
  ...
  return (
    <section
      className=" relative min-h-screen py-12 sm:py-16 px-4 sm:px-6 md:px-10 flex flex-col items-center overflow-hidden bg-gradient-to-b from-[#c7a289] via-[#f5f0eb] to-white
 opacity-90"
    >
      {/* Background Orbs */}
      <motion.div
      ...
      >
        ...
        >
          ...
          <span className="font-semibold text-maroon">
            curriculum, mentor students, deliver courses, and co-create real
            business challenges
          </span>{" "}
          by{" "}
          ...
          {features.map((feature, i) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col items-center text-center">
                <FontAwesomeIcon
                  icon={feature.icon}
                  className="text-2xl sm:text-3xl text-maroon mb-2"
                />
...
bg-gradient-to-b from-maroon-500 via-maroon-400 to-maroon-200
            ...
            >
              <h2 className="text-2xl font-bold mb-3">PGDM</h2>

              <p className="mb-4 sm:mb-6 opacity-90 text-[14px] leading-relaxed">
                Our PGDM program builds essential managerial and analytical
                skills through industry-focused learning and practical exposure,
                preparing you for strong leadership roles.
              </p>
            </div>
            ...
            >
              <p className="text-[14px] text-justify text-gray-700 leading-relaxed">
                ...
                <span className="font-semibold text-maroon">
                  SSBM's – Sona School of Business & Management
                </span>{" "}
                because it is the only place where business education meets
                technology, innovation, and global industry relevance—creating
                leaders who are built for the future.
              </p>
            </motion.div>
            ...
            <div className="px-6 sm:px-8  border border-gray-100 ">
              <p className="text-[14px] text-gray-600 leading-relaxed mb-6">
                <span className="font-semibold text-maroon">PGDM</span> gives
                you the skills and mindset to excel in modern business roles.
              </p>
            </div>
          </div>
        </motion.div>
