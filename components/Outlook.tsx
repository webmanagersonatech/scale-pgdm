...
export default function OutlookPage() {
  const features = [
    ...
    },
    {
      ...
      description:
        "The Sona Group’s impact in technology, manufacturing, education, and innovation forms a solid foundation for SSBM's cutting-edge business education model.",
      icon: faChartBar,
